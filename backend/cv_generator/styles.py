...
class CVStyles:
    ...
    THEMES = {
        "classic": {
            ...
            "subheading": {"fontsize": "14pt", "fontweight": "bold", "color": "#34495e"},
            "section": {"fontsize": "12pt", "fontweight": "bold", "color": "#34495e"},
            "normal": {"fontsize": "11pt", "color": "#2c3e50"},
            "spacing": {"heading": ("0.5cm", "0.3cm"), "subheading": ("0.4cm", "0.2cm"),
                        "section": ("0.3cm", "0.15cm"), "normal": ("0cm", "0.1cm")},
        },
        "modern": {
            "fontfamily": "Liberation Sans",
            "heading": {"fontsize": "19pt", "fontweight": "bold", "color": "#1b3a57"},
            "subheading": {"fontsize": "13pt", "fontweight": "bold", "color": "#1f4c6b"},
            "section": {"fontsize": "11.5pt", "fontweight": "bold", "color": "#1f4c6b"},
            "normal": {"fontsize": "10.5pt", "color": "#23313f"},
            "spacing": {"heading": ("0.45cm", "0.25cm"), "subheading": ("0.35cm", "0.18cm"),
                        "section": ("0.25cm", "0.12cm"), "normal": ("0cm", "0.12cm")},
        },
        "minimal": {
            "fontfamily": "Liberation Sans",
            "heading": {"fontsize": "17pt", "fontweight": "bold", "color": "#111111"},
            "subheading": {"fontsize": "12.5pt", "fontweight": "bold", "color": "#222222"},
            "section": {"fontsize": "11pt", "fontweight": "bold", "color": "#222222"},
            "normal": {"fontsize": "10.5pt", "color": "#222222"},
            "spacing": {"heading": ("0.35cm", "0.2cm"), "subheading": ("0.25cm", "0.15cm"),
                        "section": ("0.2cm", "0.1cm"), "normal": ("0cm", "0.08cm")},
        },
        "elegant": {
            "fontfamily": "Liberation Serif",
            "heading": {"fontsize": "19pt", "fontweight": "bold", "color": "#5a3e2b"},
            "subheading": {"fontsize": "14pt", "fontweight": "bold", "color": "#6b4a34"},
            "section": {"fontsize": "12pt", "fontweight": "bold", "color": "#6b4a34"},
            "normal": {"fontsize": "11pt", "color": "#3a2b23"},
            "spacing": {"heading": ("0.55cm", "0.28cm"), "subheading": ("0.4cm", "0.2cm"),
                        "section": ("0.3cm", "0.14cm"), "normal": ("0cm", "0.1cm")},
        },
        "accented": {
            "fontfamily": "Liberation Sans",
            "heading": {"fontsize": "18pt", "fontweight": "bold", "color": "#2c3e50"},
            "subheading": {"fontsize": "12.5pt", "fontweight": "bold", "color": "#2c3e50"},
            "section": {"fontsize": "11.5pt", "fontweight": "bold", "color": "#2c3e50"},
            "normal": {"fontsize": "10.5pt", "color": "#2f2f2f"},
            "accent": "#e67e22",
            "spacing": {"heading": ("0.4cm", "0.2cm"), "subheading": ("0.25cm", "0.15cm"),
                        "section": ("0.2cm", "0.1cm"), "normal": ("0cm", "0.1cm")},
        },
    }
    ...
    def create_styles(doc: OpenDocumentText, theme: str = "classic"):
        ...
        heading_style.addElement(ParagraphProperties(
            margintop=spacing["heading"][0],
            marginbottom=spacing["heading"][1]
        ))
        ...
        section_style.addElement(ParagraphProperties(
            margintop=spacing["section"][0],
            marginbottom=spacing["section"][1]
        ))
        ...
        normal_style.addElement(ParagraphProperties(
            margintop=spacing["normal"][0],
            marginbottom=spacing["normal"][1]
        ))
        ...
        topbar_style.addElement(TextProperties(
            fontfamily=fontfamily,
            fontsize="2pt",
            color=accent
        ))
        topbar_style.addElement(ParagraphProperties(
        ...
        header_name_style.addElement(TextProperties(
            fontfamily=fontfamily,
            fontsize="20pt",
            fontweight="bold",
        ...
        header_title_style.addElement(TextProperties(
            fontfamily=fontfamily,
            fontsize="12.5pt",
            fontweight="bold",
            color=accent
        ...
        body_table_style.addElement(TableProperties(
            align="left",
            border="none"
        ))
        ...
        main_cell_style.addElement(TableCellProperties(
            padding="0.2cm",
            border="none"
        ))
        ...
        header_cell_left.addElement(TableCellProperties(
            padding="0.2cm",
            border="none"
        ))
        ...
        header_cell_right.addElement(TableCellProperties(
            padding="0.2cm",
            border="none"
        ))
        ...
        side_cell_style.addElement(TableCellProperties(
            padding="0.2cm",
            borderleft=f"0.04cm solid {accent}",
            border="none"
        ))
        doc.styles.addElement(side_cell_style)

        photo_frame_style = Style(name="PhotoFrame", family="graphic")
        photo_frame_style.addElement(GraphicProperties(
            stroke="solid",
            strokecolor="#c0c0c0",
            fillcolor="#f4f4f4"
        ))
        ...
        photo_text_style.addElement(TextProperties(
            fontfamily=fontfamily,
            fontsize="10pt",
            color="#666666"
        ))
        photo_text_style.addElement(ParagraphProperties(
            textalign="center",
            marginbottom="0cm"
        ))
